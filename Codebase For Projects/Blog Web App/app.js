...
async function main() {
  ...
  app.post('/compose', function(req, res) {
    ...
    // Post.posts("req.body.postTitle").insertOne(post, function(err, res) {
    //   if (err) throw err;
    ...
    // Post.findOne({name: req.body.postTitle}, function(err, foundList) {
    //   foundList.content.push(req.body.postBody);
    //   foundList.save();
    //   res.redirect("/");
  ...
  app.get('/posts/:postId', function(req, res) {
    // const urlId = _.kebabCase(req.params.postId);
    ...
    Post.findOne({title: urlTitle}, function(err, post){
      res.render("post", {
        title: post.title,
...
// temporarily have "/node_modules" out of gitignore